...
export const ContextChat: React.FC<ContextChatProps> = ({ contextId, contextName }) => {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-gray-50 rounded-lg shadow-md overflow-hidden">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200">
        <div className="font-semibold text-lg truncate" title={contextName}>{contextName}</div>
